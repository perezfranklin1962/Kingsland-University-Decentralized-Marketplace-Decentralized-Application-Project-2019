...
import "./FranklinDecentralizedMarketplaceData.sol";
...
contract FranklinDecentralizedMarketplaceMediation {
    ...
    // Below is a Contract to hold some of the data, because when attempt made to deploy, I was not able to do so due to exceeding number of bytes limit by EVM (Ethereum Virtual Machine).
    // Must be set by the Contract Owner of the FranklinDecentralizedMarketplace Contract.
    FranklinDecentralizedMarketplaceData public franklinDecentralizedMarketplaceDataContract;
    bool public franklinDecentralizedMarketplaceDataContractHasBeenSet;
    ...
    function setFranklinDecentralizedMarketplaceDataContract(address franklinDecentralizedMarketplaceDataContractAddress) public {
        require(msg.sender == contractOwner, "This method may only be executed by the Contract Owner!");
        require(!franklinDecentralizedMarketplaceDataContractHasBeenSet, "The franklinDecentralizedMarketplacDataContract reference has already been set!");
        
        FranklinDecentralizedMarketplaceData temp = FranklinDecentralizedMarketplaceData(franklinDecentralizedMarketplaceDataContractAddress);
        require(contractOwner == temp.contractOwner(), "Must be same Contract Owner in both the FranklinDecentralizedMarketplace and FranklinDecentralizedMarketplaceData contracts!");
        
        franklinDecentralizedMarketplaceDataContract = temp;
        franklinDecentralizedMarketplaceDataContractHasBeenSet = true;
    }
    ...
    function addOrUpdateMediator(string memory _mediatorIpfsHashDescription) public {
        franklinDecentralizedMarketplaceDataContract.setDescriptionInfoAboutMediator(msg.sender, _mediatorIpfsHashDescription);
    ...
    function _purchaseItemWithMediator(address _buyerAddress, address _sellerAddress, address _mediatorAddress, string memory _mediatedSalesTransactionIpfsHash, 
        ...
        require(!franklinDecentralizedMarketplaceDataContract.mediatedSalesTransactionExists(_mediatedSalesTransactionIpfsHash), "Mediated Sales Transaction already exists!");
        ...
        franklinDecentralizedMarketplaceDataContract.setMediatedSalesTransactionExistsFlag(_mediatedSalesTransactionIpfsHash, true);
        ...
        franklinDecentralizedMarketplaceDataContract.addMediatedSalesTransactionsAddressInvolved(_buyerAddress, _mediatedSalesTransactionIpfsHash);
        franklinDecentralizedMarketplaceDataContract.addMediatedSalesTransactionsAddressInvolved(_sellerAddress, _mediatedSalesTransactionIpfsHash);
        franklinDecentralizedMarketplaceDataContract.addMediatedSalesTransactionsAddressInvolved(_mediatorAddress, _mediatedSalesTransactionIpfsHash); 
        ...
        // 3) If neither (1) or (2) above happens, then the Mediated Sales Transaction will be held in a State of Limbo and the "totalAmountOfWeiNeededToPurchase" will be kept inside 
        //    of this Contract.
        franklinDecentralizedMarketplaceDataContract.setMediatedSalesTransactionAmount(_mediatedSalesTransactionIpfsHash, totalAmountOfWeiNeededToPurchase);
        
        franklinDecentralizedMarketplaceDataContract.setNumberOfMediationsMediatorInvolved(_mediatorAddress, 
            GeneralUtilities._safeMathAdd(franklinDecentralizedMarketplaceDataContract.numberOfMediationsMediatorInvolved(_mediatorAddress), 1));
    }
    ...
    function approveMediatedSalesTransaction(string memory _mediatedSalesTransactionIpfsHash) public {
        require(franklinDecentralizedMarketplaceDataContract.mediatedSalesTransactionExists(_mediatedSalesTransactionIpfsHash), "Given Mediated Sales Transaction IPFS Hash does not exist!");
        ...
        require(!franklinDecentralizedMarketplaceDataContract.mediatedSalesTransactionHasBeenDisapproved(_mediatedSalesTransactionIpfsHash), 
        ...
        if (franklinDecentralizedMarketplaceDataContract.mediatedSalesTransactionHasBeenApproved(_mediatedSalesTransactionIpfsHash)) {
            franklinDecentralizedMarketplaceDataContract.setMediatedSalesTransactionApprovedByPartiesFlag(_mediatedSalesTransactionIpfsHash, indexBuyerSellerOrMediator, true);
            return;
        }
        ...
        franklinDecentralizedMarketplaceDataContract.setMediatedSalesTransactionApprovedByPartiesFlag(_mediatedSalesTransactionIpfsHash, indexBuyerSellerOrMediator, true);
        franklinDecentralizedMarketplaceDataContract.setMediatedSalesTransactionDisapprovedByPartiesFlag(_mediatedSalesTransactionIpfsHash, indexBuyerSellerOrMediator, false);
        ...
        if (franklinDecentralizedMarketplaceDataContract.mediatedSalesTransactionHasBeenApproved(_mediatedSalesTransactionIpfsHash)) {
            uint totalSalesAmount = franklinDecentralizedMarketplaceDataContract.mediatedSalesTransactionAmount(_mediatedSalesTransactionIpfsHash);
    ...
    function disapproveMediatedSalesTransaction(string memory _mediatedSalesTransactionIpfsHash) public {
        ...
        require(!franklinDecentralizedMarketplaceDataContract.mediatedSalesTransactionHasBeenApproved(_mediatedSalesTransactionIpfsHash), 
        ...
        if (franklinDecentralizedMarketplaceDataContract.mediatedSalesTransactionHasBeenDisapproved(_mediatedSalesTransactionIpfsHash)) {
            franklinDecentralizedMarketplaceDataContract.setMediatedSalesTransactionDisapprovedByPartiesFlag(_mediatedSalesTransactionIpfsHash, indexBuyerSellerOrMediator, true);
            return;
        }
        ...
        franklinDecentralizedMarketplaceDataContract.setMediatedSalesTransactionApprovedByPartiesFlag(_mediatedSalesTransactionIpfsHash, indexBuyerSellerOrMediator, false);
        franklinDecentralizedMarketplaceDataContract.setMediatedSalesTransactionDisapprovedByPartiesFlag(_mediatedSalesTransactionIpfsHash, indexBuyerSellerOrMediator, true);
